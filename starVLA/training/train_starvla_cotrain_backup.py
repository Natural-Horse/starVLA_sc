...
class VLAMTrainer(TrainerUtils):
    ...
    def _get_next_eval_batch(self):
        ...
        if self.vla_eval_dataloader is None or self.vlm_eval_dataloader is None:
    ...
    def eval_action_model(self, step_metrics: dict = None) -> float:
        ...
        examples, batch_vlm = self._get_next_eval_batch()
    ...
    def _finalize_training(self):
        ...
        # 确保所有进程都参与 state_dict 的收集，避免 ZeRO-3 死锁
        state_dict = self.accelerator.get_state_dict(self.model)
...
def main(cfg) -> None:
    ...
    vla_train_dataloader, vlm_train_dataloader, vla_eval_dataloader, vlm_eval_dataloader, split_summary = prepare_data(
        cfg=cfg,
